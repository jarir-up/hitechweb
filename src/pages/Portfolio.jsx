        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-gray-400 max-w-xl text-lg leading-relaxed">
              Print projects delivered to businesses, schools, and institutions across Karachi — produced on our precision offset press.
            </p>
          </motion.div>
        </div>
      </section>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="p-5 flex flex-col flex-1">
                      ...
                      <h3 className="font-bold text-[#1A1A1A] text-base mb-2 leading-snug">
                        {item.title}
                      </h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
          ...
          >
            ...
            <a
              ...
              className="inline-flex items-center gap-2 bg-[#25D366] hover:bg-[#1EB854] text-white font-bold px-8 py-3.5 rounded transition-colors"
            >
